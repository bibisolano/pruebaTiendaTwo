...
import com.tiendatwo.repository.RolRepository;
import com.tiendatwo.repository.UsuarioRepository;
   ...
   // no dejar campos en blanco 
    ...
    public void save(Usuario usuario, MultipartFile imagenFile, boolean encriptaClave) {
        ...
        if (imagenFile != null && !imagenFile.isEmpty()) { //Si no está vacío... pasaron una imagen...            
            try {
                String rutaImagen = firebaseStorageService.uploadImage(  // terminar de repasar estos datos :) 
...
// repasar borrado logico y borrado fisico en bd 
    @Transactional
