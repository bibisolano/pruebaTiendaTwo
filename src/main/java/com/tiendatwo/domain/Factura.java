...
// uno de los desafios que encontramos es que se encuentra en hora griga
// y esta hay que convertila hora de cr (central)
// fetch es para un sistema transaccional 
//quiere decir que vaya ejecucion por ejecucion 
