...
public class UsuarioController {
    ...
    public String inicio(Model model) {
        var usuarios = usuarioService.getUsuarios(false); // renderiza los usuarios y la cantidad total 
    ...
    @PostMapping("/eliminar") // se aplica el delite 
...
//  lo que esta antes de un controller es una vista (html)
// repasar categoria y productos MUY IMPORTANTE 

// estudiar usuario controller 