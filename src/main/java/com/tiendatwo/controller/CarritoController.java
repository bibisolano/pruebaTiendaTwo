...
import com.tiendatwo.domain.Item;
import com.tiendatwo.domain.Factura;
import com.tiendatwo.domain.Usuario;
import com.tiendatwo.service.CarritoService;
import com.tiendatwo.service.FacturaService;
import com.tiendatwo.service.UsuarioService;
...
public class CarritoController {
    ...
    // el metodo constructor funciona para instanciar un objeto 
    ...
    public String listado(HttpSession session, Model model) {
        ...
        model.addAttribute("totalCarrito", carritoService.calcularTotal(carrito)); // funcion
